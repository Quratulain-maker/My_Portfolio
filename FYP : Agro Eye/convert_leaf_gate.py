"""
Convert the trained leaf-gate ONNX model to TFLite for the Flutter app.

Run in the `py311_ml` env (has onnx2tf). Mirrors convert_best_mobilenetv3_small.py.
Produces assets/ml/leaf_detector.tflite + assets/ml/leaf_metadata.json.
"""
...
ONNX_PATH = ROOT / "output_leaf" / "best_leaf_gate.onnx"
TF_OUT_DIR = ROOT / "output_leaf" / "best_leaf_gate_tf"
ASSET_MODEL_PATH = ROOT / "assets" / "ml" / "leaf_detector.tflite"
ASSET_METADATA_PATH = ROOT / "assets" / "ml" / "leaf_metadata.json"
...
def write_metadata():
    metadata = {
        "model_name": "mobilenet_v3_small_leaf_gate",
        "source_checkpoint": "best_leaf_gate.pth",
